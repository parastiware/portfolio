    ...
    <div class="container">
        <div class="row">
            <div class="col col-lg-2">
                ...
                ?>
                <p>I am <?php echo ($data['Fname']);
                        echo ("&nbsp;");
                        echo ($data['Mname']);
                        echo ("&nbsp;");
                        echo ($data['Lname']); ?> and welcome to my site.</p>
            </div>
            <div class="col">
    ...
    <div class="review-form">
        ...
        <div>
            <form action="server.php" method="POST">
                ...
                <span id="success-msg"><?php echo ($_SESSION['review-sucess']);
                                        $_SESSION['review-sucess'] = ""; //clear review variable
                                        ?></span>
                <span id="error-msg"><?php echo ($_SESSION['review-error']);
                                        $_SESSION['review-error'] = ""; //clear review variable
                                        ?></span>
            </form>
        </div>
